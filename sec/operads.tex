...
Operads an props are respectively $\mathrm{S}$-modules and $\mathrm{S}$-bimodules enriched with further compositional structure.
...
\begin{definition} [\cite{may1972geometry}, \cite{boardman1973homotopy}] \label{def: e-infinity operad and prop}
